...
@available(iOS 14.0, *)
class HouseholdItemsViewController: UIViewController {
    ...
    var householditemsvideoProcessingChain: HouseholdItemsVideoProcessingChain!
...
extension HouseholdItemsViewController {
    ...
    override func viewDidLoad() {
        ...
        householditemsvideoProcessingChain = HouseholdItemsVideoProcessingChain()
        householditemsvideoProcessingChain.delegate = self
...
extension HouseholdItemsViewController: VideoCaptureDelegate {
    ...
    func videoCapture(_ videoCapture: VideoCapture,
        ...
        householditemsvideoProcessingChain.upstreamFramePublisher = framePublisher
    }
}

// MARK: - video-processing chain Delegate
extension HouseholdItemsViewController: HouseholdItemsVideoProcessingChainDelegate {
    ...
    /// - Tag: detectedAction
    func householditemsvideoProcessingChain(_ chain: HouseholdItemsVideoProcessingChain,
