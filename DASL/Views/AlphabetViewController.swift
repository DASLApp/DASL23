...
class AlphabetViewController: UIViewController {
    ...
    var alphabetvideoProcessingChain: AlphabetVideoProcessingChain!
...
extension AlphabetViewController {
    ...
    override func viewDidLoad() {
        ...
        alphabetvideoProcessingChain = AlphabetVideoProcessingChain()
        alphabetvideoProcessingChain.delegate = self
...
extension AlphabetViewController: VideoCaptureDelegate {
    ...
    func videoCapture(_ videoCapture: VideoCapture,
        ...
        alphabetvideoProcessingChain.upstreamFramePublisher = framePublisher
    }
}

// MARK: - video-processing chain Delegate
extension AlphabetViewController: AlphabetVideoProcessingChainDelegate {
    ...
    /// - Tag: detectedAction
    func alphabetvideoProcessingChain(_ chain: AlphabetVideoProcessingChain,
