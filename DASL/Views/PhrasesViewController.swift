...
class PhrasesViewController: UIViewController {
    ...
    var phrasesvideoProcessingChain: PhrasesVideoProcessingChain!
...
extension PhrasesViewController {
    ...
    override func viewDidLoad() {
        ...
        phrasesvideoProcessingChain = PhrasesVideoProcessingChain()
        phrasesvideoProcessingChain.delegate = self
...
extension PhrasesViewController: VideoCaptureDelegate {
    ...
    func videoCapture(_ videoCapture: VideoCapture,
        ...
        phrasesvideoProcessingChain.upstreamFramePublisher = framePublisher
    }
}

// MARK: - video-processing chain Delegate
extension PhrasesViewController: PhrasesVideoProcessingChainDelegate {
    ...
    /// - Tag: detectedAction
    func phrasesvideoProcessingChain(_ chain: PhrasesVideoProcessingChain,
