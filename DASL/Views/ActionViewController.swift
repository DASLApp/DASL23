...
class ActionViewController: UIViewController {
    ...
    var actionvideoProcessingChain: ActionVideoProcessingChain!
...
extension ActionViewController {
    ...
    override func viewDidLoad() {
        ...
        actionvideoProcessingChain = ActionVideoProcessingChain()
        actionvideoProcessingChain.delegate = self
...
extension ActionViewController: VideoCaptureDelegate {
    ...
    func videoCapture(_ videoCapture: VideoCapture,
        ...
        actionvideoProcessingChain.upstreamFramePublisher = framePublisher
    }
}

// MARK: - video-processing chain Delegate
extension ActionViewController: ActionVideoProcessingChainDelegate {
