...
protocol ActionVideoProcessingChainDelegate: AnyObject {
    ...
    func actionvideoProcessingChain(_ chain: ActionVideoProcessingChain,
...
struct ActionVideoProcessingChain {
    ...
    weak var delegate: ActionVideoProcessingChainDelegate?
    ...
    private let actionClassifier = ActionModel.shared
...
extension ActionVideoProcessingChain {
...
extension ActionVideoProcessingChain {
    ...
    private func findPosesInFrame(_ frame: CGImage) -> [Pose]? {
        ...
        DispatchQueue.main.async {
            self.delegate?.actionvideoProcessingChain(self, didDetect: poses, in: frame)
        }
    ...
    private func sendPrediction(_ actionPrediction: ActionPrediction) {
        ...
        DispatchQueue.main.async {
            self.delegate?.actionvideoProcessingChain(self,
