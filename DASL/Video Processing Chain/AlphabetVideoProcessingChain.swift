...
protocol AlphabetVideoProcessingChainDelegate: AnyObject {
...
struct AlphabetVideoProcessingChain {
    ...
    weak var delegate: AlphabetVideoProcessingChainDelegate?
    ...
    private let actionClassifier = Alphabet.shared
...
extension AlphabetVideoProcessingChain {
...
extension AlphabetVideoProcessingChain {
    ...
    private func findPosesInFrame(_ frame: CGImage) -> [Pose]? {
        ...
        DispatchQueue.main.async {
            self.delegate?.alphabetvideoProcessingChain(self, didDetect: poses, in: frame)
        }
    ...
    private func sendPrediction(_ actionPrediction: ActionPrediction) {
        ...
        DispatchQueue.main.async {
            self.delegate?.alphabetvideoProcessingChain(self,
