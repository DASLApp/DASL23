...
protocol PhrasesVideoProcessingChainDelegate: AnyObject {
...
struct PhrasesVideoProcessingChain {
    ...
    weak var delegate: PhrasesVideoProcessingChainDelegate?
    ...
    private let actionClassifier = DASL_phrases_model_1.shared
...
extension PhrasesVideoProcessingChain {
...
extension PhrasesVideoProcessingChain {
    ...
    private func findPosesInFrame(_ frame: CGImage) -> [Pose]? {
        ...
        DispatchQueue.main.async {
            self.delegate?.phrasesvideoProcessingChain(self, didDetect: poses, in: frame)
        }
    ...
    private func sendPrediction(_ actionPrediction: ActionPrediction) {
        ...
        DispatchQueue.main.async {
            self.delegate?.phrasesvideoProcessingChain(self,
