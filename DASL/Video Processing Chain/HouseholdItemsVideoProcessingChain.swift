...
protocol HouseholdItemsVideoProcessingChainDelegate: AnyObject {
...
struct HouseholdItemsVideoProcessingChain {
    ...
    weak var delegate: HouseholdItemsVideoProcessingChainDelegate?
    ...
    private let actionClassifier = DASL_Household_items_model_1.shared
...
extension HouseholdItemsVideoProcessingChain {
...
extension HouseholdItemsVideoProcessingChain {
    ...
    private func findPosesInFrame(_ frame: CGImage) -> [Pose]? {
        ...
        DispatchQueue.main.async {
            self.delegate?.householditemsvideoProcessingChain(self, didDetect: poses, in: frame)
        }
    ...
    private func sendPrediction(_ actionPrediction: ActionPrediction) {
        ...
        DispatchQueue.main.async {
            self.delegate?.householditemsvideoProcessingChain(self,
